      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" v-model="book.name" :class="{ 'is-invalid': submitted && $v.book.name.$error }"/>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" id="price" name="price" class="form-control" v-model="book.price" :class="{ 'is-invalid': submitted && $v.book.price.$error }"/>
